        ...
        <div class="container text-center">
            ...
            <div class="row h-100">
                <div class="col-lg-8 mx-auto align-self-center">
                    ...
                    <p><span class="opacity-70 mr-1">By</span> <a class="text-white" href="#">{{strtoupper($post->user->name)}}</a>
                    </p>
                    <p><img class="avatar avatar-sm" src="http://placehold.it/200x200" alt="..."></p>
                    ...
                    <div class="col-lg-8 mx-auto">
                        ...
                        <script>
                            ...
                            (function () { // DON'T EDIT BELOW THIS LINE
                                ...
                                s.src = 'https://cms-opikar8ztj.disqus.com/embed.js';
